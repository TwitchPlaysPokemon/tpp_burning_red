...
pub fn get_map_requirements() -> HashMap<u8, u32> {
    hashmap!(
        ...
        PEWTER_CITY              => G_NONE,
        CERULEAN_CITY            => G_NONE,
        LAVENDER_TOWN            => G_NONE,
        VERMILION_CITY           => G_NONE,
        CELADON_CITY             => G_NONE,
        FUCHSIA_CITY             => G_NONE,
        CINNABAR_ISLAND          => G_NONE,
        INDIGO_PLATEAU           => G_NONE,
        SAFFRON_CITY             => G_NONE,
        ROUTE_1                  => G_NONE,
        ROUTE_2                  => G_NONE,
        ROUTE_3                  => G_NONE,
        ...
        VIRIDIAN_GYM             => G_NONE,
        DIGLETTS_CAVE_EXIT       => G_NONE,
        VIRIDIAN_FOREST_EXIT     => G_NONE,
        ROUTE_2_HOUSE            => G_NONE,
        ROUTE_2_GATE             => G_NONE,
        VIRIDIAN_FOREST_ENTRANCE => G_NONE,
        VIRIDIAN_FOREST          => G_NONE,
        MUSEUM_1F                => G_NONE,
        MUSEUM_2F                => G_NONE,
        PEWTER_GYM               => G_NONE,
        ...
        MT_MOON_2                => G_NONE,
        MT_MOON_3                => G_NONE,
        TRASHED_HOUSE            => G_NONE,
        CERULEAN_HOUSE_1         => G_NONE,
        CERULEAN_POKECENTER      => G_NONE,
        CERULEAN_GYM             => G_NONE,
        BIKE_SHOP                => G_NONE,
        CERULEAN_MART            => G_NONE,
        MT_MOON_POKECENTER       => G_NONE,
        ROUTE_5_GATE             => G_NONE,
        PATH_ENTRANCE_ROUTE_5    => G_NONE,
        DAYCAREM                 => G_NONE,
        ROUTE_6_GATE             => G_NONE,
        ...
        ROCK_TUNNEL_POKECENTER   => G_NONE,
        ROCK_TUNNEL_1            => G_NONE,
        POWER_PLANT              => G_NONE,
        ...
        VERMILION_GYM            => G_NONE,
        VERMILION_HOUSE_1        => G_NONE,
        VERMILION_DOCK           => G_NONE,
        SS_ANNE_1                => G_NONE,
        SS_ANNE_2                => G_NONE,
        SS_ANNE_3                => G_NONE,
        SS_ANNE_4                => G_NONE,
        ...
        SEAFOAM_ISLANDS_2        => G_NONE,
        SEAFOAM_ISLANDS_3        => G_NONE,
        SEAFOAM_ISLANDS_4        => G_NONE,
        SEAFOAM_ISLANDS_5        => G_NONE,
        VERMILION_HOUSE_2        => G_NONE,
        FUCHSIA_HOUSE_3          => G_NONE,
        MANSION_1                => G_NONE,
        CINNABAR_GYM             => G_NONE,
        CINNABAR_LAB_1           => G_NONE,
        CINNABAR_LAB_2           => G_NONE,
        CINNABAR_LAB_3           => G_NONE,
        CINNABAR_LAB_4           => G_NONE,
        CINNABAR_POKECENTER      => G_NONE,
        CINNABAR_MART            => G_NONE,
        INDIGO_PLATEAU_LOBBY     => G_NONE,
        COPYCATS_HOUSE_1F        => G_NONE,
        COPYCATS_HOUSE_2F        => G_NONE,
        FIGHTING_DOJO            => G_NONE,
        SAFFRON_GYM              => G_NONE,
        SAFFRON_HOUSE_1          => G_NONE,
        SAFFRON_MART             => G_NONE,
        SILPH_CO_1F              => G_NONE,
        SAFFRON_POKECENTER       => G_NONE,
        SAFFRON_HOUSE_2          => G_NONE,
        ROUTE_15_GATE_1F         => G_NONE,
        ROUTE_15_GATE_2F         => G_NONE,
        ROUTE_16_GATE_1F         => G_NONE,
        ROUTE_16_GATE_2F         => G_NONE,
        ROUTE_16_HOUSE           => G_NONE,
        ROUTE_12_HOUSE           => G_NONE,
        ROUTE_18_GATE_1F         => G_NONE,
        ROUTE_18_GATE_2F         => G_NONE,
        SEAFOAM_ISLANDS_1        => G_NONE,
        ROUTE_22_GATE            => G_NONE,
        VICTORY_ROAD_2           => G_NONE,
        ROUTE_12_GATE_2F         => G_NONE,
        VERMILION_HOUSE_3        => G_NONE,
        DIGLETTS_CAVE            => G_NONE,
        VICTORY_ROAD_3           => G_NONE,
